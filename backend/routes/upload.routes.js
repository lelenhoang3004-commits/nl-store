...
const authorizeProductImageUpload = authorize({
  ...
  permissions: [
    AUTH_PERMISSIONS.PRODUCT_CREATE,
    AUTH_PERMISSIONS.PRODUCT_UPDATE,
    AUTH_PERMISSIONS.PRODUCT_MANAGE,
    AUTH_PERMISSIONS.CATEGORY_CREATE,
    AUTH_PERMISSIONS.CATEGORY_UPDATE,
    AUTH_PERMISSIONS.CATEGORY_MANAGE
  ],
  permissionMode: "any"
});
