...
function formPayload(form) {
  ...
  return {
    ...
    price: Number(d.get("price")), sale_price: d.get("sale_price") === "" ? null : Number(d.get("sale_price")), stock: Number(d.get("stock") || 0), rating_average: d.get("rating_average") === "" ? 4.8 : Number(d.get("rating_average")), status: d.get("status"),
