    ...
    <tr>
      ...
      <td>
        <div class="admin-users-actions">
          ...
          <button type="button" data-user-action="toggle" data-user-id="${escapeHtml(user.id)}" title="${user.status === "locked" ? "M? kh�a" : "Kh�a"}" aria-label="${user.status === "locked" ? "M? kh�a ngu?i d�ng" : "Kh�a ngu?i d�ng"}"><i class="fa-solid ${user.status === "locked" ? "fa-lock-open" : "fa-lock"}"></i></button>
